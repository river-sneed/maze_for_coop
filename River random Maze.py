...
pygame.display.set_caption("Randomly Generating maze")
...
while not done:
    ...
    if direction==0:
        if j!=0:
            if place[i][j-1]==0:
                pygame.draw.line(screen,FUN_COLOR,[space*i+102,space*j+100],[space*i+99+space,space*j+100],2)
                wall[i][j][0]=0
                j=j-1
                place[i][j]=1
                wall[i][j][1]=0
        ...
        if j!=width-1:
            if place[i][j+1]==0:
                pygame.draw.line(screen,FUN_COLOR,[space*i+102,space*j+100+space],[space*i+99+space,space*j+100+space],2)
                wall[i][j][1]=0
                j=j+1
                place[i][j]=1
                wall[i][j][0]=0
        ...
        if i!=0:
            if place[i-1][j]==0:
                pygame.draw.line(screen,FUN_COLOR,[space*i+100,space*j+102],[space*i+100,space*j+99+space],2)
                wall[i][j][2]=0
                i=i-1
                place[i][j]=1
                wall[i][j][3]=0
        ...
        if i!=length-1:
            if place[i+1][j]==0:
                pygame.draw.line(screen,FUN_COLOR,[space*i+100+space,space*j+102],[space*i+100+space,space*j+99+space],2)
                wall[i][j][3]=0
                i=i+1
                place[i][j]=1
                wall[i][j][2]=0
